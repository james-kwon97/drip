      ...
      <div className="about-page-container">
        ...
        <div className="about-page-content">
          ...
          <p className="about-text-one">
            {isEnglish
              ? 'I whakatūria i te tau 2024, ko drip: tētahi tohu kawhe rangatira e aro ana ki te tuku i ngā wheako kawhe tino pai rawa atu.'
              : 'Established in 2024, drip: is a premium coffee brand dedicated to delivering exceptional coffee experiences.'}
          </p>

          <p className="about-text-two">
            {isEnglish
              ? 'Ko tā mātou ngākau nui ki te kounga me te pono e whakaohooho ana i a mātou ki te tuku i ngā ranunga kawhe me ngā hua tino pai rawa, me te tautoko i te hapori kawhe o te ao.'
              : 'Our passion for quality and authenticity inspires us to provide the finest coffee blends and products, while supporting the global coffee community.'}
          </p>
